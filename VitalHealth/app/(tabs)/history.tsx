...
/**
 * INSIGHTS SCREEN (Replaces Old History)
...
export default function InsightsScreen() {
  ...
  }, [refreshAnalytics, refreshSessions, twinStatus]);
    ...
    return (
      <View style={[styles.container, { backgroundColor: c.bg }]}>
        ...
        <View style={styles.emptyContainer}>
          ...
          <TouchableOpacity 
            style={[styles.btn, { backgroundColor: c.active }]}
    ...
    <View style={[styles.container, { backgroundColor: c.bg }]}>
      ...
      >
        ...
        <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.horizontalScroll}>
          {organScores?.scores && Object.keys(organScores.scores).length > 0 ? (
            Object.entries(organScores.scores).map(([name, data]: [string, any]) => (
             ...
             <View style={{ width: SCREEN_WIDTH - 40, alignItems: 'center', padding: 20 }}>
               <Text style={{ color: c.sub }}>Run a simulation to generate health scores.</Text>
             </View>
          )}
        </ScrollView>
...
const styles = StyleSheet.create({
  ...
  btn: { paddingHorizontal: 30, paddingVertical: 12, borderRadius: 25, marginTop: 25 },
